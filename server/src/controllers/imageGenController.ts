...
import { z } from "zod";
import type { PosterLookId } from "@hc/shared";
import { POSTER_LOOK_IDS } from "@hc/shared";
import { HttpError } from "../middleware/errorHandler";
import { generatePosterImageFromText } from "../services/openaiImageService";

const posterLookSchema = z.enum(
  POSTER_LOOK_IDS as unknown as [PosterLookId, ...PosterLookId[]]
);
...
export async function generateImageFromCalendarText(req: Request, res: Response): Promise<void> {
